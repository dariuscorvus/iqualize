...
iQualize is signed with an ad-hoc signature, not a Developer ID certificate, and it isn't notarized. macOS puts a quarantine flag on anything downloaded from the web, and for an app it can't verify that shows up as a malware warning on first launch. Nothing is wrong with the download — Gatekeeper is reporting that the app hasn't been through Apple's notarization service, which requires a paid developer account.
...
The GUI route works too, but it takes four screens and the first one looks like a dead end — worth knowing what's coming.

**1. Open iQualize.** You get this. There is no "open anyway" here; that is expected. Click **Done** — *not* Move to Trash.

<img src="./assets/gatekeeper-1-blocked.webp" alt="macOS dialog: iQualize Not Opened — Apple could not verify iQualize is free of malware" width="340">
...
<img src="./assets/gatekeeper-3-confirm.webp" alt="macOS dialog: Open iQualize? — with Move to Trash, Open Anyway, and Done buttons" width="340">
...
<img src="./assets/gatekeeper-4-audio-permission.webp" alt="macOS dialog: iQualize would like access to record your system audio" width="340">
